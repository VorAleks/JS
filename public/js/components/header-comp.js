      ...
      <div class="container">
          <div class="page-header-wrp center">
              <div class="page-header-btn-wrp">
                  <a href="index.html" class="page-header-logo"> <img src="img/logo.png" alt="logo"
                          height="38"></a>
                  <header-filter></header-filter>
              </div>
              <div class="page-header-btn-wrp">
                  <nav class="menu">
                  <button class="page-header-menu-btn" @click="showMenu = !showMenu">
                    <span></span>
                  </button>
...
Vue.component("header-menu-comp", {
    template:`
        <ul class="menu-list" v-show="$parent.showMenu">
            <li>
...
Vue.component("header-filter", {
    ...
    template:`
    <form action="#" class="page-header-search-form" @submit.prevent="$root.$refs.products.filter(userSearch)">
                      <input class="page-header-search-btn" id="search-btn" type="search" v-model="userSearch">
