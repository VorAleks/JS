Vue.component('products-list', {
    ...
    mounted() {
        this.$parent.getJson(`/api/goodsList`)
            .then(data => {
    ...
    <section class="products center">
        ...
        <product-item v-for="item in filtered" 
        :product="item"
        :key="item.id_product">
        </product-item>
    ...
    template: `
                ...
                <a href="product.html" class="products-link">
                    <div class="products-item-photo-wrp">
                        <img class="products-item-photo" :src="product.imgProduct" alt="photo" height="420">
                    </div>
                    <div class="products-item-txt-wrp">
                        <span class="products-item-title">{{product.product_name}}</span>
                        <p class="products-item-txt">{{product.description}}</p>
